...
# Create output files
errors = open('C:\\Users\\u672901\\Google Drive\\Python Library\\Address Verification\\errors.csv', 'w')
verified = open('C:\\Users\\u672901\\Google Drive\\Python Library\\Address Verification\\verified.csv', 'w')
